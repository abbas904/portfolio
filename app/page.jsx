...
const Home = () => {
  return (
    <section className="min-h-screen flex flex-col">
      <div className="container mx-auto flex-1 px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="flex flex-col xl:flex-row items-center justify-between gap-8 sm:gap-12 lg:gap-16 xl:gap-20">
          {/* text */}
